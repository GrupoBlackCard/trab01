...
INSERT INTO Promocoes(id_promocao,desconto_promocao,validade_promocao,tipo_promocao,descricao_promocao,cnpj_promocao,cpf_promocao) values
...
('2','2018-06-08','2020-08-12','Entrar com arma branca no estabelecimento','32.444.564/0001-00','880.208.195-68');

insert into Eventos (id_evento,descricao_evento,data_evento,preco_evento,hora_evento,cnpj_restricao) values
